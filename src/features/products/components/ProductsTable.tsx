...
import type { ProductPrivate, ProductPrivateList } from "../types/product";
...
const ProductsTable = ({ isLoading, data, onRestore, onDelete, onEdit, onModalOpen }: ProductsTableProps) => {
                    ...
                    data.data.map((item) => {
                        ...
                        return (
                            <Table.Tr key={item.id} opacity={isDeleted ? 0.6 : undefined} >
                                ...
                                <Table.Td>
                                    <Text size="sm" c={item.stock > 0 ? "teal" : "red"} lineClamp={1}>
                                        {item.stock || "—"}
                                    </Text>
                                </Table.Td>
                                <Table.Td>
                                    <Group gap="xs" justify="center">
                                        ...
                                        <Button size="xs" variant="subtle" onClick={() => navigate(`/admin/products/detail/${item.id}`)}>
                                            Ver detalle
                                        </Button>
                                    </Group>
                                </Table.Td>
